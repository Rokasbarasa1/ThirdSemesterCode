using AutoMapper;
using Session6_WebApi.API.Controllers;
using Session6_WebApi.API.DataContracts.Requests;
using Session6_WebApi.API.DataContracts;
...
namespace Session6_WebApi.API.Tests.Controllers.ControllerTests
{
    [TestClass]
